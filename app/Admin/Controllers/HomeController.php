    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->row(function ($row) {
                $row->column(3, new InfoBox('Матрасы', 'hdd-o', 'aqua', '/admin/mattress', Item::where('type_item_id', 1)->count()));
                $row->column(3, new InfoBox('Наматрасники', 'clone', 'green', '/admin/mattresscovers', Item::where('type_item_id', 4)->count()));
                $row->column(3, new InfoBox('Подушки', 'lemon-o', 'yellow', '/admin/pillows', Item::where('type_item_id', 2)->count()));
                $row->column(3, new InfoBox('Основания', 'road', 'red', '/admin/slatteds', Item::where('type_item_id', 3)->count()));
                $row->column(3, new InfoBox('Кровати', 'bed', 'blue', '/admin/beds', Item::where('type_item_id', 5)->count()));
            });
