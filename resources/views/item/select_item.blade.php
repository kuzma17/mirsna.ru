...
<div style="margin-top:10px;margin-left:10px"><strong style="color:#FF8000">По Вашему запрсу:</strong><br>
    ...
    @if(isset($user_request['height_m'])) Высота: {{ $user_request['height_m'] }} <br> @endif
    ...
    @if(isset($user_request['weight_m'])) Макс.вес на место: {{ $user_request['weight_m'] }} <br> @endif
...
<table class="select_item" cellspacing="1" cellpadding="1" width="100%">
    <tbody>
    <tr class="head_table">
        <TD>бренд</TD><TD>модель</TD><TD>размер</TD><TD>высота</TD><TD>пружинный блок</TD><TD>жесткость</TD><TD>макс.вес<br>на место</TD><TD>цена</TD>
    </tr>
